...
INC = -Iinclude # add search path to header file
LIB = -lpthread # compile agaist POSIX threads library
...
# searching directory for prerequisites, selective search
vpath %.c $(SRC)	
vpath %.h $(INCLUDE)
